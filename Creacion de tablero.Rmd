...
Subtitle: "Actividad 1 - Métodos y Simulación Estadística"
output: 
  flexdashboard::flex_dashboard:
    theme:
      bg: "#006633" #Background Color
      fg: "#FFFFFF" #font color
      primary: "#66FF66" #main title
      base_font:
        google: Prompt
      code_font:
...
origen= c("Bogotá","Buenaventura","Buga","Cali","Candelaria","Ginebra","Jamundi","Jamundí","Palmira","Panamá","Paz_De_Ariporo","Puerto_Tejada","Rosario","Tuluá","Villa_Rica","Yumbo")
...
paleta6=c("#447270","#6B9493", "#F6E271", "#F69312", "#BC6C25")
p1=ggplot(CarreraLuz22, aes(y=timerun/60, x=categoria))+
  geom_jitter(color="#00FF66", , size=1, alpha=0.9) +
  aes(color=paleta6)+
  labs(title = " ",
       y= "tiempo - min",
       x= "categorías")+ 
...
### Tiempos de carrera Ciudades Principales

```{r, fig.height=3, fig.width=6}
CarreraLuz22_subset <- subset(CarreraLuz22, origen %in% c("Bogotá", "Cali", "Buenaventura","Palmira"))

p3 <- ggplot(CarreraLuz22_subset, aes(y=timerun/60, x=origen)) +
  geom_bin2d(color="#003333", fill = "#006666", size=1, alpha=0.9) +
  aes(color=paleta6) +
  labs(title = "", y= "Tiempo (min)", x= "origen") +
  ylim(25,120) +
  Theme2
...
### Tiempos de carrera Mujeres ciudades principales
```{r, fig.height=5, fig.width=6}
CarreraLuz22F_subset <- subset(CarreraLuz22, origen %in% c("Bogotá", "Cali", "Buenaventura","Palmira"))
p2=ggplot(CarreraLuz22F_subset, aes(y=timerun/60, x=origen))+
  geom_jitter(color="#FF3333", , size=1, alpha=0.9) +
  aes(color=paleta6)+
  labs(title = " ",
       y= "tiempo - min",
       x= "categorías")+ 
...
### Tiempos de carrera Hombres ciudades principales

```{r, fig.height=5, fig.width=6}

CarreraLuz22M_subset <- subset(CarreraLuz22, origen %in% c("Bogotá", "Cali", "Buenaventura","Palmira"))

p3=ggplot(CarreraLuz22M_subset, aes(y=timerun/60, x=origen))+
  geom_jitter(color="#003366", , size=1, alpha=0.9) +
  aes(color=paleta6)+
  labs(title = " ",
       y= "tiempo - min",
       x= "categorías")+ 
...
```{r, echo=FALSE, out.width="30%", fig.align = "Bottom"}
...
```{r}
CarreraLuz22_subset1 <- subset(CarreraLuz22, origen %in% c("Cali"))

valueBox(value = paste(length(CarreraLuz22_subset1$timerun),"atletas"), 
         caption = "Número de participantes Cali", 
         icon = "fa-people", 
         color = "#0EB0C6")
```
